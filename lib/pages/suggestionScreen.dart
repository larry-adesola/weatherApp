      ...
      child: Column(
        ...
        children: [
          Row(
            ...
            children: [
              Container(
                margin: EdgeInsets.only(top: 50), // Move buttons down by 50 pixels
                child: ButtonBar(
                  children: [
                    ElevatedButton(
                      onPressed: () {
                      ...
                      style: ElevatedButton.styleFrom(
                        fixedSize: const Size(70, 70), backgroundColor: _selectedDay == 0 ? Colors.blue : null,
                    ...
                    ElevatedButton(
                      ...
                      style: ElevatedButton.styleFrom(
                        fixedSize: const Size(70, 70), backgroundColor: _selectedDay == 2 ? Colors.blue : null,
                        shape: const CircleBorder(), // Change color when selected
                      ),
                      child: Text(
                    ...
                    ElevatedButton(
                      ...
                      style: ElevatedButton.styleFrom(
                        fixedSize: const Size(70, 70), backgroundColor: _selectedDay == 3 ? Colors.blue : null,
                        shape: const CircleBorder(), // Change color when selected
                      ),
                      child: Text(
          ...
          FutureBuilder(
              ...
              builder: (context, snapshot) {
                if (snapshot.connectionState == ConnectionState.waiting) {
                  ...
                  return const Text('Error creating suggestions',
                    style: TextStyle(fontSize: 10),);
                }
                print(_selectedDay);
                print(snapshot.data?['dt']);
                String time = DateFormat('HH:mm').format(DateTime.fromMillisecondsSinceEpoch(snapshot.data?['dt'] * 1000).toLocal()).substring(0, 5);
